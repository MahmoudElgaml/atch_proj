        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Image.asset(Assets.imagesGLogo,),
                ...
                const Gap(32),
                CostumeTextFiled(
                  validator: (value) => ValidationService.validateEmpty(value, "Company"),
                  title: "Company Name",
                  textEditingController: companyName,
                ),
                const Gap(20),
                CostumeTextFiled(
                  validator: (value) => ValidationService.validateEmpty(value, "Advertise Name"),
                ...
                const Gap(20),
                CostumeTextFiled(
                  validator: (value) => ValidationService.validateEmpty(value, "Your Phone"),
                ...
                const Gap(20),
                CostumeTextFiled(
                  validator: (value) => ValidationService.validateEmpty(value, "Your Location"),
                  title: "location",
